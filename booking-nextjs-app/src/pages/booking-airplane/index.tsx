          ...
          <form className='px-6 py-8 flex flex-col gap-4'>
            <div className='flex flex-row gap-5'>
              <div className='flex flex-row gap-2'>
                ...
                />
                <SelectInput
                  className='h-10 w-[88px]'
                  title='Аэропорт'
                  data={airports}
                  value={formData.toAirport}
                  onChange={(value) => handleChange('toAirport', value)}
                  paddingX='[10px]'
                  paddingY='[10px]'
                  disabled
                  typeCombobox={true}
              ...
              <div className='flex flex-row gap-2'>
                <SelectInput
                  ...
                  onChange={(value) => handleChange('toCity', value)}
                  paddingX='[14px]'
                  paddingY='[8px]'
                  typeCombobox={false}
                ...
                <SelectInput
                  ...
                  onChange={(value) => handleChange('fromAirport', value)}
                  paddingX='[10px]'
                  paddingY='[10px]'
                  disabled={true}
                  typeCombobox={true}
            ...
            <div className='flex flex-row gap-2'>
              ...
              <SelectInput
                ...
                onChange={(value) => handleChange('classType', value)}
                disabled={false}
                paddingX='[14px]'
                paddingY='[10px]'
            ...
            <div className='flex flex-row gap-2'>
              ...
              <div className='flex flex-col gap-1'>
                <CalendarInput
                  ...
                  disabled={enabled}
                  placeholder={
                    enabled ? 'Без обратного билета' : 'Выберите дату'
                  }
                  hideCalendarIcon={enabled}
                  required={!enabled}
                />
